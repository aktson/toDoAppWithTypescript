...
export function renderTasks(tasks) {
    ...
    function handleEditEvent(event) {
        ...
        const editInputs = document.querySelectorAll("#edit-task-input");
    ...
    // 	saveToStorage(toDoList, updatedTaskList);
    // }
    function updateValueInTaskList(id, value, taskList) {
    ...
    function deleteTask(event) {
        ...
        const filteredTasks = tasks.filter((task) => parseInt(task.id) !== parseInt(id));
        saveToStorage(toDoList, filteredTasks);
        const newListItems = getFromStorage(toDoList);
        tasksContainer.innerHTML = "";
